...
- Add matrix inversion linear solver with neumann series approximation by [@Benjamin-eecs](https://github.com/Benjamin-eecs) in [#98](https://github.com/metaopt/torchopt/pull/98).
