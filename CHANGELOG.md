...
- Implement `AdaDelta`, `RAdam`, `Adamax` optimizer by [@Benjamin-eecs](https://github.com/Benjamin-eecs) and [@JieRen98](https://github.com/JieRen98) in [#171](https://github.com/metaopt/torchopt/pull/171).
